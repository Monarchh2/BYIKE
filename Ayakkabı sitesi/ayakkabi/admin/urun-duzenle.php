        ...
        <div id="page-wrapper">
            <div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">  ÜRÜN DÜZENLE</h3>
                         <?php if ($_GET['durum']=="ok") { ?>
                            ...
                            <?php } else { ?>
                                <p class="text-muted m-b-30"> ÜRÜN Düzenleyin</p>
                            <?php } ?> <hr><br>

 

<form action="netting/islem-admin.php" method="POST"    enctype="multipart/form-data">
 <input type="hidden" name="eskiyol" value="<?php echo $uruncek['urun_resimyol']; ?>">
 <input type="hidden" name="id" value="<?php echo $uruncek['id']; ?>">
 <div class="form-group">


<div class="form-group">
<img width="150" src="../<?php echo $uruncek['urun_resimyol']; ?>"> 
...
<input type="file" name="urun_resimyol"   > </span> <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Sil</a> 
...
<input type="text" class="form-control"  name="baslik" value="<?php echo $uruncek['baslik']; ?>" required="required"> 
<div class="help-block with-errors"></div>
</div>
...
<input type="number" class="form-control"  name="fiyat" value="<?php echo $uruncek['fiyat']; ?>" required="required" > 
<div class="help-block with-errors"></div>
</div>
...
<textarea  class="form-control"  name="detay"><?php echo $uruncek['detay']; ?></textarea> <span class="help-block with-errors"> Açıklama Girin</span> </div>
